    ...
    <div class="main-wrapper">
            ...
            <div class="container eduvibe-animated-shape">
                <div class="row row--50">
                    <div class="col-lg-6">
                        <div class="about-image-gallery">
                            <img src="client_assets/images/swarohi/facebook_1685556819561_7069737710514171373.jpg" width="100%" alt="">
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="inner mt_md--40 mt_sm--40">
                            <div class="section-title" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                                <span class="pre-title">About Swarohi </span>
                                <h3 class="title"></h3>
                            </div>
                            <p class="description mt--40 mt_md--20 mt_sm--20" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Sunt, quasi! Accusantium cupiditate facere alias mollitia nemo repellat tempora nostrum, odio natus! Enim mollitia optio praesentium officiis, id voluptates? Totam doloremque distinctio doloribus porro nam numquam dignissimos ratione dolores blanditiis provident, est explicabo voluptas ipsam. Commodi pariatur laboriosam tempore quia eum.
                            </p>
                        
                            <p class="description mt--40 mt_md--20 mt_sm--20" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Quibusdam doloribus animi, et nam quis harum enim ipsa dolorem perferendis nihil dolorum saepe molestiae voluptatum quod optio fugiat tempore pariatur ullam vel accusamus debitis qui dignissimos. Sapiente, doloremque sed earum commodi obcaecati, mollitia sint nulla eveniet nobis voluptatum aliquam beatae facilis.
                            </p>
                ...
                <div class="shape-dot-wrapper shape-wrapper d-xl-block d-none">
                    <div class="shape-image shape-image-1">
                        <img src="client_assets/images/shapes/shape-11-05.png" alt="Shape Thumb" />
                    </div>
                    <div class="shape-image shape-image-2">
                        <img src="client_assets/images/shapes/shape-08-01.png" alt="Shape Thumb" />
                    </div>
                    <div class="shape-image shape-image-3">
                        <img src="client_assets/images/shapes/shape-30.png" alt="Shape Thumb" />
                    </div>
                    <div class="shape shape-1"><span class="shape-dot"></span></div>
                </div>
                <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Dicta neque nobis qui placeat ea quaerat ullam, dignissimos facere beatae aperiam eveniet sint quo labore similique suscipit laborum provident corrupti enim, minima non. Suscipit error ipsam inventore eligendi earum laborum doloribus.
                </p>
            </div>
        </div>
        ...
        <div class="eduvibe-about-us-one-service edu-service-area edu-section-gapBottom bg-color-white service-bg-position">
            <div class="container eduvibe-animated-shape">
                ...
                <div class="shape-dot-wrapper shape-wrapper d-xl-block d-none">
                    <div class="shape-image shape-image-1">
                        <img src="client_assets/images/shapes/shape-04-03.png" alt="Shape Thumb" />
                    </div>
                    <div class="shape-image shape-image-2">
                        <img src="client_assets/images/shapes/shape-02-07.png" alt="Shape Thumb" />
                    </div>
                    <div class="shape-image shape-image-3">
                        <img src="client_assets/images/shapes/shape-15.png" alt="Shape Thumb" />
                    </div>
                </div>
            </div>
        </div>
        <div class="eduvibe-about-us-one-service edu-service-area edu-section-gapBottom bg-color-white service-bg-position">
            <div class="container eduvibe-animated-shape">
                ...
                <div class="grid_list">
                    ...
                    $list = glob("client_assets/images/faculties/sarmistha/*.*");
                    natsort($list);
