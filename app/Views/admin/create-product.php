    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                <!--begin::Form-->
                <form id="kt_ecommerce_add_product_form" class="form d-flex flex-column flex-lg-row" method="post" action="admin/create-product" enctype="multipart/form-data">
                    <!--begin::Aside column-->
                    <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                            ...
                            <div class="card-body text-center pt-0">
                                ...
                                <div class="image-input image-input-empty image-input-outline mb-3" data-kt-image-input="true" style="background-image: url(./assets/media/svg/files/blank-image.svg)">
                                    ...
                                    <label class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-body shadow" data-kt-image-input-action="change" data-bs-toggle="tooltip" title="Change avatar">
                                        ...
                                        <!--begin::Inputs-->
                                        <input required type="file" name="product_thumbnail" accept=".png, .jpg, .jpeg" />
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <!--end::Label-->
                                <!--begin::Select2-->
                                <select class="form-select mb-2" required name='product_category' data-control="select2" data-placeholder="Select an option" data-allow-clear="true" multiple="multiple">
                                    <option></option>
                                    
                                            <option value="অনুবাদ গল্প">অনুবাদ গল্প</option>
                                            <option value="সামাজিক গল্প">সামাজিক গল্প</option>
                                            <option value="হাসির গল্প">হাসির গল্প</option>
                                            <option value="রূপকথা">রূপকথা</option>
                                            <option value="বিজ্ঞান">বিজ্ঞান</option>
                                            <option value="কল্প বিজ্ঞান">কল্প বিজ্ঞান</option>
                                            <option value="ছড়া ও কবিতা">ছড়া ও কবিতা</option>
                                            <option value="থ্রিলার">থ্রিলার</option>
                                            <option value="এডভেঞ্চার">এডভেঞ্চার</option>
                                            <option value="ভূতের গল্প">ভূতের গল্প</option>
                                            <option value="গোয়েন্দা গল্প">গোয়েন্দা গল্প</option>
                                            <option value="ভ্রমণ কাহিনী">ভ্রমণ কাহিনী</option>
                                            <option value="ঐতিহাসিক গল্প">ঐতিহাসিক গল্প</option>
                                            <option value="জীবন স্মৃতি">জীবন স্মৃতি</option>
                                            <option value="খেলার গল্প">খেলার গল্প</option>
                                    ...
                                    <div class="card card-flush py-4">
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input required type="text" name="product_name" class="form-control mb-2" placeholder="Book Title" value="" />
                                                <!--end::Input-->
                                                <!--begin::Description-->
                                            ...
                                            <div class="row">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input required type="number" name="product_price" class="form-control mb-2" placeholder="Price" value="" />
                                                <!--end::Input-->
                                                <!--begin::Description-->
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Input-->
                                                <input required type="number" name="product_offer_percent" class="form-control mb-2" placeholder="Example 5" value="" />
                                                <!--end::Input-->
                                                <!--begin::Description-->
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <!--end::Label-->
                                                <!--begin::Editor-->
                                                <input required id="kt_ecommerce_add_product_meta_keywords" name="product_meta_keywords" class="form-control mb-2" />
                                                <!--end::Editor-->
                                                <!--begin::Description-->
                                            ...
                                            <div class="mb-10 fv-row">
                                                <!--begin::Label-->
                                                <label class="required form-label">Title slug(SEO)</label>
                                                <!--end::Label-->
                                                <!--begin::Editor-->
                                                <input required id="kt_ecommerce_add_product_meta_keywords" name="product_name_slug" class="form-control mb-2" placeholder="word-word-word-word" maxlength="30" />
                                                <!--end::Editor-->
                                                <!--begin::Description-->
                                            ...
                                            <div class="mb-10 fv-row">
                                                ...
                                                <div id="kt_ecommerce_add_product_description" name="kt_ecommerce_add_product_description" class="min-h-100px mb-2">
                                                    ...
                                                    <textarea class="form-control" name="product_short_desc" id="" rows="5" required></textarea>
                                                </div>
                                                <!--end::Editor-->
                                                <!--begin::Description-->
