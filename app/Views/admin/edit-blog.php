...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            <!--begin::Form-->
            <form id="kt_ecommerce_add_product_form" class="form d-flex flex-column flex-lg-row" method="POST" action="admin/edit-blog/<?= $post_id ?>" enctype="multipart/form-data">
                <!--begin::Aside column-->
                                ...
                                <div class="card card-flush py-4">
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input required type="text" name="post_title" class="form-control mb-2" placeholder="Blog Title" value="<?= $post_title;?>" />
                                            <!--end::Input-->
                                            <!--begin::Description-->
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Editor-->
                                            <input required id="kt_ecommerce_add_product_meta_keywords" name="post_meta_keywords" class="form-control mb-2" value="<?= $post_meta_keywords; ?>" />
                                            <!--end::Editor-->
                                            <!--begin::Description-->
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <div id="kt_ecommerce_add_product_description" name="kt_ecommerce_add_product_description" class="min-h-100px mb-2">
                                                ...
                                                <textarea class="form-control" name="short_desc" id="" rows="5" required><?= $post_meta_desc; ?></textarea>
                                            </div>
                                            <!--end::Editor-->
                                            <!--begin::Description-->
...
<script>
    ClassicEditor
        .create(document.querySelector('#editor'), {
            ...
            toolbar: [
                'heading', 'blockQuote', 'link', 'bold', 'italic', '|', 'bulletedList', 'numberedList', 'undo', 'redo', '|', 'insertTable', 'uploadImage', 'ckfinder'
            ],
            ckfinder: {
