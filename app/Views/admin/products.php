                    ...
                    <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                        ...
                        <thead>
                            <tr class="fw-bolder text-muted">
                                ...
                                <th class="min-w-200px">Thumbnail</th>
                                <th class="min-w-200px">Book Name</th>
                                <th class="min-w-150px">Status</th>
                                <th class="min-w-150px">Book Category</th>
                                <th class="min-w-150px">Price</th>
                                <th class="min-w-150px">Book offer %</th>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center">
                                                <div class="symbol symbol-45px me-5">
                                                    <img src="<?= '/assets/uploads/product_thumbnails/'.$product_thumbnail ?>" alt="">
                                                </div>
                                        ...
                                        <td>
                                            <div class="d-flex justify-content-end flex-shrink-0">
                                                <a href="/admin/edit-product/<?= $product_id ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                                ...
                                                <a href="/admin/delete-product/<?= $product_id ?>" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
                                                    <span class="svg-icon svg-icon-3">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
